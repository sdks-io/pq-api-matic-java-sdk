...
receiptsController.listAccountReceiptsAsync(accountToken, page, pageSize, filter, sort, language).thenAccept(result -> {
...
receiptsController.listPrepaidCardReceiptsAsync(userToken, destinationToken, page, pageSize, filter, sort, language).thenAccept(result -> {
    // TODO success callback handler
    System.out.println(result);
}).exceptionally(exception -> {
    Throwable cause = exception.getCause();
...
receiptsController.listUserReceiptsAsync(userToken, page, pageSize, filter, sort, language).thenAccept(result -> {
    // TODO success callback handler
    System.out.println(result);
}).exceptionally(exception -> {
    Throwable cause = exception.getCause();
...
receiptsController.retrieveAccountReceiptAsync(accountToken, receiptToken).thenAccept(result -> {
    // TODO success callback handler
    System.out.println(result);
}).exceptionally(exception -> {
    Throwable cause = exception.getCause();
...
receiptsController.retrievePrepaidCardReceiptAsync(userToken, destinationToken, receiptToken).thenAccept(result -> {
    // TODO success callback handler
    System.out.println(result);
}).exceptionally(exception -> {
    Throwable cause = exception.getCause();
...
receiptsController.retrieveUserReceiptAsync(userToken, receiptToken).thenAccept(result -> {
    // TODO success callback handler
    System.out.println(result);
}).exceptionally(exception -> {
    Throwable cause = exception.getCause();
