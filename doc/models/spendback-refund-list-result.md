...
|  --- | --- | --- | --- | --- | --- |
| `Payload` | [`List<SpendbackRefundObject>`](../../doc/models/spendback-refund-object.md) | Required | **Constraints**: *Minimum Items*: `1`, *Unique Items Required* | List<SpendbackRefundObject> getPayload() | setPayload(List<SpendbackRefundObject> payload) |
