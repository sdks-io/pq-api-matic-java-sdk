...
| `CardReferenceNumber` | `String` | Optional | Number that is printed on the back of a plastic card. | String getCardReferenceNumber() | setCardReferenceNumber(String cardReferenceNumber) |
