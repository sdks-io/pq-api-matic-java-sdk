...
|  --- | --- | --- | --- | --- | --- |
| `Payload` | [`List<TransferObject>`](../../doc/models/transfer-object.md) | Required | **Constraints**: *Minimum Items*: `1`, *Unique Items Required* | List<TransferObject> getPayload() | setPayload(List<TransferObject> payload) |
