...
|  --- | --- | --- | --- | --- | --- |
| `Payload` | [`List<InvitationObject>`](../../doc/models/invitation-object.md) | Required | **Constraints**: *Minimum Items*: `1`, *Unique Items Required* | List<InvitationObject> getPayload() | setPayload(List<InvitationObject> payload) |
