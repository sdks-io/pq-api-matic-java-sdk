...
| `Status` | [`ElectronicWalletStatuses`](../../doc/models/electronic-wallet-statuses.md) | Optional | Current verification status type of the electronic wallet | ElectronicWalletStatuses getStatus() | setStatus(ElectronicWalletStatuses status) |
