...
|  --- | --- | --- | --- | --- | --- |
| `Payload` | [`List<BalanceObject>`](../../doc/models/balance-object.md) | Required | **Constraints**: *Minimum Items*: `1`, *Unique Items Required* | List<BalanceObject> getPayload() | setPayload(List<BalanceObject> payload) |
