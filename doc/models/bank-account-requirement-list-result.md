...
|  --- | --- | --- | --- | --- | --- |
| `Payload` | [`List<BankAccountRequirement>`](../../doc/models/bank-account-requirement.md) | Optional | - | List<BankAccountRequirement> getPayload() | setPayload(List<BankAccountRequirement> payload) |
