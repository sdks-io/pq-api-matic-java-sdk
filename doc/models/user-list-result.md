...
|  --- | --- | --- | --- | --- | --- |
| `Payload` | [`List<UserObject>`](../../doc/models/user-object.md) | Required | **Constraints**: *Minimum Items*: `1`, *Unique Items Required* | List<UserObject> getPayload() | setPayload(List<UserObject> payload) |
