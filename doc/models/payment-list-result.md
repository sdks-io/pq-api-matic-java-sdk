...
|  --- | --- | --- | --- | --- | --- |
| `Payload` | [`List<PaymentObject>`](../../doc/models/payment-object.md) | Required | **Constraints**: *Minimum Items*: `1`, *Unique Items Required* | List<PaymentObject> getPayload() | setPayload(List<PaymentObject> payload) |
