...
|  --- | --- | --- | --- | --- | --- |
| `Payload` | [`List<WebhookSubscriptionObject>`](../../doc/models/webhook-subscription-object.md) | Required | **Constraints**: *Minimum Items*: `1`, *Unique Items Required* | List<WebhookSubscriptionObject> getPayload() | setPayload(List<WebhookSubscriptionObject> payload) |
