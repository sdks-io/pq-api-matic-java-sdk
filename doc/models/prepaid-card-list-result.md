...
|  --- | --- | --- | --- | --- | --- |
| `Payload` | [`List<PrepaidCardObject>`](../../doc/models/prepaid-card-object.md) | Required | **Constraints**: *Minimum Items*: `1`, *Unique Items Required* | List<PrepaidCardObject> getPayload() | setPayload(List<PrepaidCardObject> payload) |
