...
|  --- | --- | --- | --- | --- | --- |
| `Payload` | [`List<PaymentJobObject>`](../../doc/models/payment-job-object.md) | Required | **Constraints**: *Minimum Items*: `1`, *Unique Items Required* | List<PaymentJobObject> getPayload() | setPayload(List<PaymentJobObject> payload) |
