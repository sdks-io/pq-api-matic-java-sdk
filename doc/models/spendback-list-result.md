...
|  --- | --- | --- | --- | --- | --- |
| `Payload` | [`List<SpendbackObject>`](../../doc/models/spendback-object.md) | Required | **Constraints**: *Minimum Items*: `1`, *Unique Items Required* | List<SpendbackObject> getPayload() | setPayload(List<SpendbackObject> payload) |
