...
|  --- | --- | --- | --- | --- | --- |
| `Payload` | [`List<BankAccountObject>`](../../doc/models/bank-account-object.md) | Required | **Constraints**: *Minimum Items*: `1`, *Unique Items Required* | List<BankAccountObject> getPayload() | setPayload(List<BankAccountObject> payload) |
