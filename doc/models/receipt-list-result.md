...
|  --- | --- | --- | --- | --- | --- |
| `Payload` | [`List<ReceiptObject>`](../../doc/models/receipt-object.md) | Required | **Constraints**: *Minimum Items*: `1`, *Unique Items Required* | List<ReceiptObject> getPayload() | setPayload(List<ReceiptObject> payload) |
