...
|  --- | --- | --- | --- | --- | --- |
| `Payload` | [`List<StatementObject>`](../../doc/models/statement-object.md) | Required | **Constraints**: *Minimum Items*: `1`, *Unique Items Required* | List<StatementObject> getPayload() | setPayload(List<StatementObject> payload) |
