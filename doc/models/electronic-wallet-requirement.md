...
| `SourceCountry` | [`Countries`](../../doc/models/countries.md) | Optional | Throughout the PayQuicker API, the usage of the 2-letter alpha code is used in place of the country name, e.g., for bank country or residential country.<br><br>The 2-letter codes adhere to the ISO 3166-1 spec and are listed here for convenience. | Countries getSourceCountry() | setSourceCountry(Countries sourceCountry) |
...
| `Requirements` | [`List<ElectronicWalletRequiredFields>`](../../doc/models/electronic-wallet-required-fields.md) | Optional | - | List<ElectronicWalletRequiredFields> getRequirements() | setRequirements(List<ElectronicWalletRequiredFields> requirements) |
