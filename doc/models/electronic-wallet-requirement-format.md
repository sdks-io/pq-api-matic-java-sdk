...
| `Legend` | [`List<ElectronicWalletRequirementFormatLegend>`](../../doc/models/electronic-wallet-requirement-format-legend.md) | Optional | - | List<ElectronicWalletRequirementFormatLegend> getLegend() | setLegend(List<ElectronicWalletRequirementFormatLegend> legend) |
