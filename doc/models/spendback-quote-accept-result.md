...
| `ClientSpendbackId` | `String` | Optional | [Unique value](#/rest/models/structures/client-transfer-id) provided by the client for the spendback | String getClientSpendbackId() | setClientSpendbackId(String clientSpendbackId) |
...
| `Fee` | [`FeeConfiguration`](../../doc/models/fee-configuration.md) | Optional | - | FeeConfiguration getFee() | setFee(FeeConfiguration fee) |
...
| `Refunds` | [`List<SpendbackRefundObject>`](../../doc/models/spendback-refund-object.md) | Optional | - | List<SpendbackRefundObject> getRefunds() | setRefunds(List<SpendbackRefundObject> refunds) |
