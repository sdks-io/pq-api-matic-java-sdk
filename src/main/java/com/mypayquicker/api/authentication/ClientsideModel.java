...
public class ClientsideModel {
    ...
    /**
     * A Constructor for ClientsideModel.
     */
    private ClientsideModel(String accessToken) {
    ...
    /**
     * Builds a new {@link ClientsideModel.Builder} object.
     * Creates the instance with the state of the current auth model.
     * @return a new {@link ClientsideModel.Builder} object.
     */
    ...
    public static class Builder {
        ...
        /**
         * Builds the instance of ClientsideModel using the provided credentials.
         * @return The instance of ClientsideModel.
         */
        public ClientsideModel build() {
            return new ClientsideModel(accessToken);
        }
    }
}