...
/**
 * This is a model class for TransferResult type.
 */
public class TransferResult
    ...
    /**
     * Converts this TransferResult into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "TransferResult [" + "token=" + token + ", portalId=" + portalId
                ...
                + ", transferMethodType=" + transferMethodType + ", links=" + links + ", meta="
                + meta + ", additionalProperties=" + getAdditionalProperties() + "]";
    }

    /**
     * Builds a new {@link TransferResult.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link TransferResult.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link TransferResult}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link TransferResult} object using the set fields.
         * @return {@link TransferResult}
         */
        public TransferResult build() {
            return new TransferResult(token, portalId, clientTransferId, created, deliveryDetails,
