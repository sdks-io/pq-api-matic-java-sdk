...
/**
 * This is a model class for GatewayPaymentQuote type.
 */
public class GatewayPaymentQuote
        extends BaseModel {
    ...
    /**
     * Converts this GatewayPaymentQuote into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "GatewayPaymentQuote [" + "amount=" + amount + ", currency=" + currency
    ...
    /**
     * Builds a new {@link GatewayPaymentQuote.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link GatewayPaymentQuote.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link GatewayPaymentQuote}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link GatewayPaymentQuote} object using the set fields.
         * @return {@link GatewayPaymentQuote}
         */
        public GatewayPaymentQuote build() {
            return new GatewayPaymentQuote(amount, currency, sourceToken, destinationToken, note,
