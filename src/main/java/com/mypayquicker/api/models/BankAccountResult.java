...
/**
 * This is a model class for BankAccountResult type.
 */
public class BankAccountResult
    ...
    /**
     * Converts this BankAccountResult into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "BankAccountResult [" + "token=" + token + ", bankAccountOwnershipType="
    ...
    /**
     * Builds a new {@link BankAccountResult.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link BankAccountResult.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link BankAccountResult}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link BankAccountResult} object using the set fields.
         * @return {@link BankAccountResult}
         */
        public BankAccountResult build() {
            return new BankAccountResult(token, bankAccountOwnershipType, bankCountry, bankCurrency,
