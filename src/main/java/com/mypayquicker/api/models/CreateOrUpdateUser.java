...
/**
 * This is a model class for CreateOrUpdateUser type.
 */
public class CreateOrUpdateUser
    ...
    /**
     * Converts this CreateOrUpdateUser into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "CreateOrUpdateUser [" + "currency=" + currency + ", programUserId=" + programUserId
    ...
    /**
     * Builds a new {@link CreateOrUpdateUser.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link CreateOrUpdateUser.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link CreateOrUpdateUser}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link CreateOrUpdateUser} object using the set fields.
         * @return {@link CreateOrUpdateUser}
         */
        public CreateOrUpdateUser build() {
            return new CreateOrUpdateUser(currency, programUserId, email, firstName, lastName,
