...
/**
 * This is a model class for PrepaidCardObject type.
 */
public class PrepaidCardObject
        extends BaseModel {
    ...
    /**
     * Converts this PrepaidCardObject into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "PrepaidCardObject [" + "token=" + token + ", cardNetwork=" + cardNetwork
    ...
    /**
     * Builds a new {@link PrepaidCardObject.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link PrepaidCardObject.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link PrepaidCardObject}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link PrepaidCardObject} object using the set fields.
         * @return {@link PrepaidCardObject}
         */
        public PrepaidCardObject build() {
            return new PrepaidCardObject(token, cardNetwork, cardNumber, cardPackage, country,
