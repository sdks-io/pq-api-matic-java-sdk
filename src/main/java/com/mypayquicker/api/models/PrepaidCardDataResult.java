...
/**
 * This is a model class for PrepaidCardDataResult type.
 */
public class PrepaidCardDataResult
        extends BaseModel {
    ...
    /**
     * Converts this PrepaidCardDataResult into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "PrepaidCardDataResult [" + "cardNumber=" + cardNumber + ", cvvNumber=" + cvvNumber
    ...
    /**
     * Builds a new {@link PrepaidCardDataResult.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link PrepaidCardDataResult.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link PrepaidCardDataResult}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link PrepaidCardDataResult} object using the set fields.
         * @return {@link PrepaidCardDataResult}
         */
        public PrepaidCardDataResult build() {
            return new PrepaidCardDataResult(cardNumber, cvvNumber, expiration, nameOnCard, token,
                    links, meta);
        }
    }
}
