...
/**
 * This is a model class for PaymentJobObject type.
 */
public class PaymentJobObject
        extends BaseModel {
    ...
    /**
     * Converts this PaymentJobObject into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "PaymentJobObject [" + "token=" + token + ", portalId=" + portalId + ", filename="
                + filename + ", fileToken=" + fileToken + ", created=" + created + ", notBefore="
                + notBefore + ", count=" + count + ", type=" + type + ", status=" + status
                + ", items=" + items + ", links=" + links + ", additionalProperties="
                + getAdditionalProperties() + "]";
    }

    /**
     * Builds a new {@link PaymentJobObject.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link PaymentJobObject.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link PaymentJobObject}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link PaymentJobObject} object using the set fields.
         * @return {@link PaymentJobObject}
         */
        public PaymentJobObject build() {
            return new PaymentJobObject(token, portalId, filename, fileToken, created, notBefore,
                    count, type, status, items, links);
        }
    }
}
