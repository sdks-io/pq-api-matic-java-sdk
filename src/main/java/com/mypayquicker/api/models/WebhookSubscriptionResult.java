...
/**
 * This is a model class for WebhookSubscriptionResult type.
 */
public class WebhookSubscriptionResult
    ...
    /**
     * Converts this WebhookSubscriptionResult into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "WebhookSubscriptionResult [" + "token=" + token + ", created=" + created
                + ", lastUpdated=" + lastUpdated + ", url=" + url + ", namespace=" + namespace
                + ", status=" + status + ", links=" + links + ", meta=" + meta
                + ", additionalProperties=" + getAdditionalProperties() + "]";
    }

    /**
     * Builds a new {@link WebhookSubscriptionResult.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link WebhookSubscriptionResult.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link WebhookSubscriptionResult}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link WebhookSubscriptionResult} object using the set fields.
         * @return {@link WebhookSubscriptionResult}
         */
        public WebhookSubscriptionResult build() {
            return new WebhookSubscriptionResult(token, created, lastUpdated, url, namespace,
                    status, links, meta);
        }
    }
}
