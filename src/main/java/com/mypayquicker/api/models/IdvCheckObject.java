...
/**
 * This is a model class for IdvCheckObject type.
 */
public class IdvCheckObject
        extends BaseModel {
    ...
    /**
     * Converts this IdvCheckObject into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "IdvCheckObject [" + "token=" + token + ", userToken=" + userToken
                ...
                + ", idvDisposition=" + idvDisposition + ", links=" + links
                + ", additionalProperties=" + getAdditionalProperties() + "]";
    }

    /**
     * Builds a new {@link IdvCheckObject.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link IdvCheckObject.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link IdvCheckObject}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link IdvCheckObject} object using the set fields.
         * @return {@link IdvCheckObject}
         */
        public IdvCheckObject build() {
            return new IdvCheckObject(token, userToken, idvProviderReference, idvResult,
