...
/**
 * This is a model class for ElectronicWalletResult type.
 */
public class ElectronicWalletResult
        extends BaseModel {
    ...
    /**
     * Converts this ElectronicWalletResult into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "ElectronicWalletResult [" + "token=" + token + ", type=" + type
    ...
    /**
     * Builds a new {@link ElectronicWalletResult.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link ElectronicWalletResult.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link ElectronicWalletResult}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link ElectronicWalletResult} object using the set fields.
         * @return {@link ElectronicWalletResult}
         */
        public ElectronicWalletResult build() {
            return new ElectronicWalletResult(token, type, electronicWalletCountry,
                    electronicWalletCurrency, createdOn, fields, status, links, meta);
        }
    }
}
