...
/**
 * This is a model class for SpendbackRefundResult type.
 */
public class SpendbackRefundResult
        extends BaseModel {
    ...
    /**
     * Converts this SpendbackRefundResult into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "SpendbackRefundResult [" + "token=" + token + ", portalId=" + portalId + ", amount="
                ...
                + ", receiptToken=" + receiptToken + ", links=" + links + ", meta=" + meta
                + ", additionalProperties=" + getAdditionalProperties() + "]";
    }

    /**
     * Builds a new {@link SpendbackRefundResult.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link SpendbackRefundResult.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link SpendbackRefundResult}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link SpendbackRefundResult} object using the set fields.
         * @return {@link SpendbackRefundResult}
         */
        public SpendbackRefundResult build() {
            return new SpendbackRefundResult(token, portalId, amount, clientSpendbackRefundId,
                    created, currency, memo, note, sourceToken, destinationToken, programUserId,
                    email, status, receiptToken, links, meta);
        }
    }
}
