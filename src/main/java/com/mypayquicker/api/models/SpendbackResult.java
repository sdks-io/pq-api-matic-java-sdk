...
/**
 * This is a model class for SpendbackResult type.
 */
public class SpendbackResult
        extends BaseModel {
    ...
    /**
     * Converts this SpendbackResult into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "SpendbackResult [" + "token=" + token + ", portalId=" + portalId + ", amount="
    ...
    /**
     * Builds a new {@link SpendbackResult.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link SpendbackResult.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link SpendbackResult}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link SpendbackResult} object using the set fields.
         * @return {@link SpendbackResult}
         */
        public SpendbackResult build() {
            return new SpendbackResult(token, portalId, amount, clientSpendbackId, created,
