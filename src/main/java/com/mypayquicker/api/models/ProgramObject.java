...
/**
 * This is a model class for ProgramObject type.
 */
public class ProgramObject
    ...
    /**
     * Converts this ProgramObject into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "ProgramObject [" + "token=" + token + ", currency=" + currency + ", bank=" + bank
                + ", type=" + type + ", electronicWallets=" + electronicWallets + ", links=" + links
                + ", additionalProperties=" + getAdditionalProperties() + "]";
    }

    /**
     * Builds a new {@link ProgramObject.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link ProgramObject.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link ProgramObject}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link ProgramObject} object using the set fields.
         * @return {@link ProgramObject}
         */
        public ProgramObject build() {
            return new ProgramObject(token, currency, bank, type, electronicWallets, links);
        }
    }
}
