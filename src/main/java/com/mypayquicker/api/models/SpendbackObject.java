...
/**
 * This is a model class for SpendbackObject type.
 */
public class SpendbackObject
        extends BaseModel {
    ...
    /**
     * Converts this SpendbackObject into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "SpendbackObject [" + "token=" + token + ", portalId=" + portalId + ", amount="
                + amount + ", clientSpendbackId=" + clientSpendbackId + ", created=" + created
                + ", currency=" + currency + ", destinationToken=" + destinationToken + ", fee="
                + fee + ", memo=" + memo + ", note=" + note + ", purpose=" + purpose
                + ", sourceToken=" + sourceToken + ", programUserId=" + programUserId + ", email="
                + email + ", status=" + status + ", receiptToken=" + receiptToken + ", refunds="
                + refunds + ", links=" + links + ", additionalProperties="
                + getAdditionalProperties() + "]";
    }

    /**
     * Builds a new {@link SpendbackObject.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link SpendbackObject.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link SpendbackObject}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link SpendbackObject} object using the set fields.
         * @return {@link SpendbackObject}
         */
        public SpendbackObject build() {
            return new SpendbackObject(token, portalId, amount, clientSpendbackId, created,
                    currency, destinationToken, fee, memo, note, purpose, sourceToken,
                    programUserId, email, status, receiptToken, refunds, links);
        }
    }
}
