...
/**
 * This is a model class for PaymentObject type.
 */
public class PaymentObject
    ...
    /**
     * Converts this PaymentObject into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "PaymentObject [" + "token=" + token + ", portalId=" + portalId + ", amount="
    ...
    /**
     * Builds a new {@link PaymentObject.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link PaymentObject.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link PaymentObject}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link PaymentObject} object using the set fields.
         * @return {@link PaymentObject}
         */
        public PaymentObject build() {
            return new PaymentObject(token, portalId, amount, clientPaymentId, created, currency,
