...
/**
 * This is a model class for StatementObject type.
 */
public class StatementObject
    ...
    /**
     * Converts this StatementObject into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "StatementObject [" + "fileContents=" + fileContents + ", filename=" + filename
    ...
    /**
     * Builds a new {@link StatementObject.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link StatementObject.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link StatementObject}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link StatementObject} object using the set fields.
         * @return {@link StatementObject}
         */
        public StatementObject build() {
            return new StatementObject(fileContents, filename, mimeType, token, userToken,
                    prepaidCardToken, from, to, links);
        }
    }
}
