...
/**
 * This is a model class for UserResult type.
 */
public class UserResult
    ...
    /**
     * Converts this UserResult into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "UserResult [" + "token=" + token + ", addressLine1=" + addressLine1
                ...
                + userType + ", links=" + links + ", meta=" + meta + ", additionalProperties="
                + getAdditionalProperties() + "]";
    }

    /**
     * Builds a new {@link UserResult.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link UserResult.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link UserResult}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link UserResult} object using the set fields.
         * @return {@link UserResult}
         */
        public UserResult build() {
            return new UserResult(token, addressLine1, addressLine2, addressLine3,
                    ...
                    taxResidentStatus, userType, links, meta);
        }
    }
}
