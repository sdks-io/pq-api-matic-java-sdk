...
/**
 * This is a model class for PaymentResult type.
 */
public class PaymentResult
    ...
    /**
     * Converts this PaymentResult into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "PaymentResult [" + "token=" + token + ", portalId=" + portalId + ", amount="
    ...
    /**
     * Builds a new {@link PaymentResult.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link PaymentResult.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link PaymentResult}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link PaymentResult} object using the set fields.
         * @return {@link PaymentResult}
         */
        public PaymentResult build() {
            return new PaymentResult(token, portalId, amount, clientPaymentId, created, currency,
