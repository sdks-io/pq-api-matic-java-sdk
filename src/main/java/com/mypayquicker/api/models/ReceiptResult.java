...
/**
 * This is a model class for ReceiptResult type.
 */
public class ReceiptResult
    ...
    /**
     * Converts this ReceiptResult into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "ReceiptResult [" + "token=" + token + ", type=" + type + ", createdOn=" + createdOn
                ...
                + ", details=" + details + ", fxRate=" + fxRate + ", links=" + links + ", meta="
                + meta + ", additionalProperties=" + getAdditionalProperties() + "]";
    }

    /**
     * Builds a new {@link ReceiptResult.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link ReceiptResult.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link ReceiptResult}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link ReceiptResult} object using the set fields.
         * @return {@link ReceiptResult}
         */
        public ReceiptResult build() {
            return new ReceiptResult(token, type, createdOn, sign, sourceToken, destinationToken,
                    amount, currency, status, descriptions, deliveryDetails, details, fxRate, links,
                    meta);
        }
    }
}
