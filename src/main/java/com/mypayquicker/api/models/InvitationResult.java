...
/**
 * This is a model class for InvitationResult type.
 */
public class InvitationResult
    ...
    /**
     * Converts this InvitationResult into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "InvitationResult [" + "token=" + token + ", portalId=" + portalId + ", amount="
    ...
    /**
     * Builds a new {@link InvitationResult.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link InvitationResult.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link InvitationResult}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link InvitationResult} object using the set fields.
         * @return {@link InvitationResult}
         */
        public InvitationResult build() {
            return new InvitationResult(token, portalId, amount, clientPaymentId, created, currency,
                    destinationToken, programUserId, email, memo, note, purpose, sourceToken,
                    status, receiptToken, links, meta);
        }
    }
}
