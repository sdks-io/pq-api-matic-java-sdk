...
/**
 * This is a model class for DocumentResult type.
 */
public class DocumentResult
    ...
    /**
     * Converts this DocumentResult into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "DocumentResult [" + "createDate=" + createDate + ", token=" + token + ", links="
                + links + ", fields=" + fields + ", filename=" + filename + ", mimeType=" + mimeType
                + ", meta=" + meta + ", additionalProperties=" + getAdditionalProperties() + "]";
    }

    /**
     * Builds a new {@link DocumentResult.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link DocumentResult.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link DocumentResult}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link DocumentResult} object using the set fields.
         * @return {@link DocumentResult}
         */
        public DocumentResult build() {
            return new DocumentResult(createDate, token, links, fields, filename, mimeType, meta);
        }
    }
}
