...
/**
 * This is a model class for BalanceObject type.
 */
public class BalanceObject
    ...
    /**
     * Converts this BalanceObject into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "BalanceObject [" + "amount=" + amount + ", currency=" + currency
                + ", formattedAmount=" + formattedAmount + ", token=" + token + ", links=" + links
                + ", additionalProperties=" + getAdditionalProperties() + "]";
    }

    /**
     * Builds a new {@link BalanceObject.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link BalanceObject.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link BalanceObject}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link BalanceObject} object using the set fields.
         * @return {@link BalanceObject}
         */
        public BalanceObject build() {
            return new BalanceObject(amount, currency, formattedAmount, token, links);
        }
    }
}
