...
/**
 * This is a model class for PrepaidCardDataTokenObject type.
 */
public class PrepaidCardDataTokenObject
        extends BaseModel {
    ...
    /**
     * Converts this PrepaidCardDataTokenObject into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "PrepaidCardDataTokenObject [" + "cardProcessorType=" + cardProcessorType
                + ", tokenPurposeType=" + tokenPurposeType + ", resourceValue=" + resourceValue
                + ", token=" + token + ", url=" + url + ", links=" + links
                + ", additionalProperties=" + getAdditionalProperties() + "]";
    }

    /**
     * Builds a new {@link PrepaidCardDataTokenObject.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link PrepaidCardDataTokenObject.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link PrepaidCardDataTokenObject}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link PrepaidCardDataTokenObject} object using the set fields.
         * @return {@link PrepaidCardDataTokenObject}
         */
        public PrepaidCardDataTokenObject build() {
            return new PrepaidCardDataTokenObject(cardProcessorType, tokenPurposeType,
                    resourceValue, token, url, links);
        }
    }
}
